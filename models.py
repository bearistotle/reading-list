...
# TODO: Increase size of review column
...
class Book(db.Model):
    ...
    def __init__(self, title, author, category, user, date_added, read=False, date_read=None, rating=None, review=None, isbn=None):
        self.title = title
        self.author = author
